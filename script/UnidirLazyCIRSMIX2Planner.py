...
from LazyCIRSMIX2Solver import LazyCIRSMIX2Solver
...
class UnidirLazyCIRSMIX2Planner(RearrangementTaskPlanner):
    def __init__(
        ...
        rospy.logwarn("initialize an unidirectional Lazy CIRSMIX version 2 planner")
    ...
    def growSubTree(self, rootNode, target_arrangement, time_allowed, isLabeledRoadmapUsed):
        ...
        lazy_cirsmix2_solver = LazyCIRSMIX2Solver(
            rootNode, target_arrangement, time_allowed, isLabeledRoadmapUsed)
        local_task_success, subTree, local_motion_planning_time = lazy_cirsmix2_solver.lazy_cirsmix2_solve()
