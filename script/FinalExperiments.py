...
class FinalExperimenter(object):
    ...
    def saveAverageSolutionPerNumObject(self):
        ...
        if len(self.Lazy_CIRSMIX3_success_obj_m) != 0:
            ...
            average_lazy_cirsmix3_success_obj_m = 0.0
        ...
        if len(self.Lazy_CIRSMIX2_success_obj_m) != 0:
            ...
            average_lazy_cirsmix2_success_obj_m = 0.0
        ...
        if len(self.Lazy_CIRSMIX_success_obj_m) != 0:
            ...
            average_lazy_cirsmix_success_obj_m = 0.0
        ...
        if len(self.CIRSMIX_success_obj_m) != 0:
            ...
            average_cirsmix_success_obj_m = 0.0
        ...
        if len(self.Lazy_CIRSMIX3_nActions_obj_m) != 0:
            ...
            average_lazy_cirsmix3_nActions_obj_m = 0.0
        ...
        if len(self.Lazy_CIRSMIX2_nActions_obj_m) != 0:
            ...
            average_lazy_cirsmix2_nActions_obj_m = 0.0
        ...
        if len(self.Lazy_CIRSMIX_nActions_obj_m) != 0:
            ...
            average_lazy_cirsmix_nActions_obj_m = 0.0
        ...
        if len(self.CIRSMIX_nActions_obj_m) != 0:
            ...
            average_cirsmix_nActions_obj_m = 0.0
        ...
        if len(self.Lazy_CIRSMIX3_success_obj_nm) != 0:
            ...
            average_lazy_cirsmix3_success_obj_nm = 0.0
        ...
        if len(self.Lazy_CIRSMIX2_success_obj_nm) != 0:
            ...
            average_lazy_cirsmix2_success_obj_nm = 0.0
        ...
        if len(self.Lazy_CIRSMIX_success_obj_nm) != 0:
            ...
            average_lazy_cirsmix_success_obj_nm = 0.0
        ...
        if len(self.CIRSMIX_success_obj_nm) != 0:
            ...
            average_cirsmix_success_obj_nm = 0.0
        ...
        if len(self.Lazy_CIRSMIX3_nActions_obj_nm) != 0:
            ...
            average_lazy_cirsmix3_nActions_obj_nm = 0.0
        ...
        if len(self.Lazy_CIRSMIX2_nActions_obj_nm) != 0:
            ...
            average_lazy_cirsmix2_nActions_obj_nm = 0.0
        ...
        if len(self.Lazy_CIRSMIX_nActions_obj_nm) != 0:
            ...
            average_lazy_cirsmix_nActions_obj_nm = 0.0
        ...
        if len(self.CIRSMIX_nActions_obj_nm) != 0:
            ...
            average_cirsmix_nActions_obj_nm = 0.0
...
def main(args):
    ...
    for num_objects in final_experimenter.numObjects_options:
        ...
        for experiment_id in range(1, final_experimenter.numExperiments_perObject+1):
            ...
            ### use Lazy_CIRSMIX3 first to classify
            ### (1) monotone problems
            ...
            if lazy_cirsmix3_isSolved:
                ### the problem is solved by lazy CIRSMIX3 in given time
                if lazy_cirsmix3_nActions == num_objects:
                    ...
                    if lazy_cirsmix3_planning_time <= final_experimenter.time_allowed_monotone:
                        ### Lazy CIRSMIX3 solves it successfully
                        ...
                        final_experimenter.Lazy_CIRSMIX3_success_obj_m.append(float(lazy_cirsmix3_isSolved))
                        final_experimenter.Lazy_CIRSMIX3_nActions_obj_m.append(lazy_cirsmix3_nActions)
                    else:
                        ### Lazy CIRSMIX3 does not solve it successfully (time limit exceeds)
                        ############# ********************************************************** #############
                        if (lazy_cirsmix3_planning_time >= final_experimenter.time_allowed_monotone + 10):
                            lazy_cirsmix3_task_planning_time -= lazy_cirsmix3_planning_time - final_experimenter.time_allowed_monotone
                            lazy_cirsmix3_planning_time = final_experimenter.time_allowed_monotone
                            lazy_cirsmix3_motion_planning_time = lazy_cirsmix3_planning_time - lazy_cirsmix3_task_planning_time
                        else:
                            ### a little bit exceed...
                            lazy_cirsmix3_motion_planning_time *= ((final_experimenter.time_allowed_monotone) / (lazy_cirsmix3_planning_time))
                            lazy_cirsmix3_task_planning_time *= ((final_experimenter.time_allowed_monotone) / (lazy_cirsmix3_planning_time))
                            lazy_cirsmix3_planning_time = final_experimenter.time_allowed_monotone
                        ############# ********************************************************** #############
                        final_experimenter.Lazy_CIRSMIX3_time_obj_m.append(lazy_cirsmix3_planning_time)
                        final_experimenter.Lazy_CIRSMIX3_motionTime_obj_m.append(lazy_cirsmix3_motion_planning_time)
                        final_experimenter.Lazy_CIRSMIX3_taskTime_obj_m.append(lazy_cirsmix3_task_planning_time)
                        lazy_cirsmix3_isSolved = False
                        final_experimenter.Lazy_CIRSMIX3_success_obj_m.append(float(lazy_cirsmix3_isSolved))
                        final_experimenter.Lazy_CIRSMIX3_nActions_obj_m.append(lazy_cirsmix3_nActions)
                else:
                    ...
                    final_experimenter.Lazy_CIRSMIX3_success_obj_nm.append(float(lazy_cirsmix3_isSolved))
                    final_experimenter.Lazy_CIRSMIX3_nActions_obj_nm.append(lazy_cirsmix3_nActions)
            else:
                ### the problem is not solved by Lazy CIRSMIX3 in given time
                ### the problem is deemed as non-monotone
                time_allowed_for_other_methods = final_experimenter.time_allowed_nonMonotone
                ############# ********************************************************** #############
                if (lazy_cirsmix3_planning_time >= final_experimenter.time_allowed_nonMonotone + 10):
                    lazy_cirsmix3_task_planning_time -= lazy_cirsmix3_planning_time - final_experimenter.time_allowed_nonMonotone
                    lazy_cirsmix3_planning_time = final_experimenter.time_allowed_nonMonotone
                    lazy_cirsmix3_motion_planning_time = lazy_cirsmix3_planning_time - lazy_cirsmix3_task_planning_time
                else:
                    ### a little bit exceed...
                    lazy_cirsmix3_motion_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (lazy_cirsmix3_planning_time))
                    lazy_cirsmix3_task_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (lazy_cirsmix3_planning_time))
                    lazy_cirsmix3_planning_time = final_experimenter.time_allowed_nonMonotone
                ############# ********************************************************** #############
                final_experimenter.Lazy_CIRSMIX3_time_obj_nm.append(lazy_cirsmix3_planning_time)
                final_experimenter.Lazy_CIRSMIX3_motionTime_obj_nm.append(lazy_cirsmix3_motion_planning_time)
                final_experimenter.Lazy_CIRSMIX3_taskTime_obj_nm.append(lazy_cirsmix3_task_planning_time)
                final_experimenter.Lazy_CIRSMIX3_success_obj_nm.append(float(lazy_cirsmix3_isSolved))
                lazy_cirsmix3_nActions = 5000 ### set np.inf to 5000
            ...
            if time_allowed_for_other_methods == final_experimenter.time_allowed_monotone:
                ############# ********************************************************** #############
                if (lazy_cirsmix2_planning_time <= final_experimenter.time_allowed_monotone): pass
                elif (lazy_cirsmix2_planning_time >= final_experimenter.time_allowed_monotone + 10):
                    lazy_cirsmix2_task_planning_time -= lazy_cirsmix2_planning_time - final_experimenter.time_allowed_monotone
                    lazy_cirsmix2_planning_time = final_experimenter.time_allowed_monotone
                    lazy_cirsmix2_motion_planning_time = lazy_cirsmix2_planning_time - lazy_cirsmix2_task_planning_time
                else:
                    ### a little bit exceed...
                    lazy_cirsmix2_motion_planning_time *= ((final_experimenter.time_allowed_monotone) / (lazy_cirsmix2_planning_time))
                    lazy_cirsmix2_task_planning_time *= ((final_experimenter.time_allowed_monotone) / (lazy_cirsmix2_planning_time))
                    lazy_cirsmix2_planning_time = final_experimenter.time_allowed_monotone
                ############# ********************************************************** #############
                ...
                ############# ********************************************************** #############
                if (lazy_cirsmix2_planning_time <= final_experimenter.time_allowed_nonMonotone): pass
                elif (lazy_cirsmix2_planning_time >= final_experimenter.time_allowed_nonMonotone + 10):
                    lazy_cirsmix2_task_planning_time -= lazy_cirsmix2_planning_time - final_experimenter.time_allowed_nonMonotone
                    lazy_cirsmix2_planning_time = final_experimenter.time_allowed_nonMonotone
                    lazy_cirsmix2_motion_planning_time = lazy_cirsmix2_planning_time - lazy_cirsmix2_task_planning_time
                else:
                    ### a little bit exceed...
                    lazy_cirsmix2_motion_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (lazy_cirsmix2_planning_time))
                    lazy_cirsmix2_task_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (lazy_cirsmix2_planning_time))
                    lazy_cirsmix2_planning_time = final_experimenter.time_allowed_nonMonotone
                ############# ********************************************************** #############
            ...
            if time_allowed_for_other_methods == final_experimenter.time_allowed_monotone:
                ############# ********************************************************** #############
                if (lazy_cirsmix_planning_time <= final_experimenter.time_allowed_monotone): pass
                elif (lazy_cirsmix_planning_time >= final_experimenter.time_allowed_monotone + 10):
                    lazy_cirsmix_task_planning_time -= lazy_cirsmix_planning_time - final_experimenter.time_allowed_monotone
                    lazy_cirsmix_planning_time = final_experimenter.time_allowed_monotone
                    lazy_cirsmix_motion_planning_time = lazy_cirsmix_planning_time - lazy_cirsmix_task_planning_time
                else:
                    ### a little bit exceed...
                    lazy_cirsmix_motion_planning_time *= ((final_experimenter.time_allowed_monotone) / (lazy_cirsmix_planning_time))
                    lazy_cirsmix_task_planning_time *= ((final_experimenter.time_allowed_monotone) / (lazy_cirsmix_planning_time))
                    lazy_cirsmix_planning_time = final_experimenter.time_allowed_monotone
                ############# ********************************************************** #############
                ...
                final_experimenter.Lazy_CIRSMIX_success_obj_m.append(lazy_cirsmix_isSolved)
                ...
                ### non-monotone problem solution
                ############# ********************************************************** #############
                if (lazy_cirsmix_planning_time <= final_experimenter.time_allowed_nonMonotone): pass
                elif (lazy_cirsmix_planning_time >= final_experimenter.time_allowed_nonMonotone + 10):
                    lazy_cirsmix_task_planning_time -= lazy_cirsmix_planning_time - final_experimenter.time_allowed_nonMonotone
                    lazy_cirsmix_planning_time = final_experimenter.time_allowed_nonMonotone
                    lazy_cirsmix_motion_planning_time = lazy_cirsmix_planning_time - lazy_cirsmix_task_planning_time
                else:
                    ### a little bit exceed...
                    lazy_cirsmix_motion_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (lazy_cirsmix_planning_time))
                    lazy_cirsmix_task_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (lazy_cirsmix_planning_time))
                    lazy_cirsmix_planning_time = final_experimenter.time_allowed_nonMonotone
                ############# ********************************************************** #############
                ...
                final_experimenter.Lazy_CIRSMIX_success_obj_nm.append(lazy_cirsmix_isSolved)
                if lazy_cirsmix_nActions != np.inf:
            ...
            if time_allowed_for_other_methods == final_experimenter.time_allowed_monotone:
                ############# ********************************************************** #############
                if (cirsmix_planning_time <= final_experimenter.time_allowed_monotone): pass
                elif (cirsmix_planning_time >= final_experimenter.time_allowed_monotone + 10):
                    cirsmix_task_planning_time -= cirsmix_planning_time - final_experimenter.time_allowed_monotone
                    cirsmix_planning_time = final_experimenter.time_allowed_monotone
                    cirsmix_motion_planning_time = cirsmix_planning_time - cirsmix_task_planning_time
                else:
                    ### a little bit exceed...
                    cirsmix_motion_planning_time *= ((final_experimenter.time_allowed_monotone) / (cirsmix_planning_time))
                    cirsmix_task_planning_time *= ((final_experimenter.time_allowed_monotone) / (cirsmix_planning_time))
                    cirsmix_planning_time = final_experimenter.time_allowed_monotone
                ############# ********************************************************** #############
                ...
                ### non-monotone problem solution
                ############# ********************************************************** #############
                if (cirsmix_planning_time <= final_experimenter.time_allowed_nonMonotone): pass
                elif (cirsmix_planning_time >= final_experimenter.time_allowed_nonMonotone + 10):
                    cirsmix_task_planning_time -= cirsmix_planning_time - final_experimenter.time_allowed_nonMonotone
                    cirsmix_planning_time = final_experimenter.time_allowed_nonMonotone
                    cirsmix_motion_planning_time = cirsmix_planning_time - cirsmix_task_planning_time
                else:
                    ### a little bit exceed...
                    cirsmix_motion_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (cirsmix_planning_time))
                    cirsmix_task_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (cirsmix_planning_time))
                    cirsmix_planning_time = final_experimenter.time_allowed_nonMonotone
                ############# ********************************************************** #############
            ...
            if time_allowed_for_other_methods == final_experimenter.time_allowed_monotone:
                ############# ********************************************************** #############
                if (cirs_planning_time <= final_experimenter.time_allowed_monotone): pass
                elif (cirs_planning_time >= final_experimenter.time_allowed_monotone + 10):
                    cirs_task_planning_time -= cirs_planning_time - final_experimenter.time_allowed_monotone
                    cirs_planning_time = final_experimenter.time_allowed_monotone
                    cirs_motion_planning_time = cirs_planning_time - cirs_task_planning_time
                else:
                    ### a little bit exceed...
                    cirs_motion_planning_time *= ((final_experimenter.time_allowed_monotone) / (cirs_planning_time))
                    cirs_task_planning_time *= ((final_experimenter.time_allowed_monotone) / (cirs_planning_time))
                    cirs_planning_time = final_experimenter.time_allowed_monotone
                ############# ********************************************************** #############
                ...
                ### non-monotone problem solution
                ############# ********************************************************** #############
                if (cirs_planning_time <= final_experimenter.time_allowed_nonMonotone): pass
                elif (cirs_planning_time >= final_experimenter.time_allowed_nonMonotone + 10):
                    cirs_task_planning_time -= cirs_planning_time - final_experimenter.time_allowed_nonMonotone
                    cirs_planning_time = final_experimenter.time_allowed_nonMonotone
                    cirs_motion_planning_time = cirs_planning_time - cirs_task_planning_time
                else:
                    ### a little bit exceed...
                    cirs_motion_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (cirs_planning_time))
                    cirs_task_planning_time *= ((final_experimenter.time_allowed_nonMonotone) / (cirs_planning_time))
                    cirs_planning_time = final_experimenter.time_allowed_nonMonotone
                ############# ********************************************************** #############
    ...
    print("FINISH ALL THE EXPERIMENTS")
